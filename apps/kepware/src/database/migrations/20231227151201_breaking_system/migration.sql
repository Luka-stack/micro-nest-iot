/*
  ...
  - Added the required column `nextMaintenance` to the `Machine` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Machine" ("defaultRate", "faultRate", "id", "maxRate", "minRate", "productionRate", "serialNumber", "version", "workBase", "workRange") SELECT "defaultRate", "faultRate", "id", "maxRate", "minRate", "productionRate", "serialNumber", "version", "workBase", "workRange" FROM "Machine";
DROP TABLE "Machine";
